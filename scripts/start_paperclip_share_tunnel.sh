...
LOG_DIR="${MAGI_LOG_DIR:-${MAGI_V3_LOG_DIR:-$MAGI_ROOT/logs}}"
AGENT_DIR="${MAGI_AGENT_DIR:-${MAGI_DATA_DIR:-$MAGI_ROOT/.agent}}"
RUNTIME_DIR="${MAGI_RUNTIME_DIR:-$MAGI_ROOT/.runtime}"
...
URL_FILE="${MAGI_OSC_FILE_SHARE_PUBLIC_BASE_FILE:-$RUNTIME_DIR/osc_share_public_base_url.txt}"
