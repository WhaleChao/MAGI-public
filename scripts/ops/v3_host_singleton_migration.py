#!/usr/bin/env python3
"""Stage V3-bound replacements for legacy host-singleton LaunchAgents.

The command is deliberately non-mutating: it reads four existing plists and
...
def render_migrated_plist(
    ...
    *,
    ...
    path_parts = [
        ...
        if part and "magi_v2" not in part.lower() and "magi-v2" not in part.lower()
    ]
