...
def _openclaw_auth_mode_guard() -> Dict[str, Any]:
    # [2026-05-03 DEPRECATED] OpenClaw auth guard script removed.
    # This stub is kept so the MAGI_TICK_OPENCLAW_AUTH_GUARD_ENABLE / MAGI_SELFTEST_OPENCLAW_AUTH_GUARD_ENABLE
    # env-flag paths remain valid as emergency killswitches.
    return {"ok": True, "status": "deprecated", "reason": "OpenClaw removed; guard script deleted 2026-05-03"}
...
def _openclaw_model_guard(auto_restart: bool = True) -> Dict[str, Any]:
    # [2026-05-03 DEPRECATED] OpenClaw model guard removed.
    # This stub is kept so the MAGI_TICK_OPENCLAW_MODEL_GUARD_ENABLE / MAGI_SELFTEST_OPENCLAW_MODEL_GUARD_ENABLE
    # env-flag paths remain valid as emergency killswitches.
    return {"ok": True, "status": "deprecated", "reason": "OpenClaw removed; model guard deleted 2026-05-03"}
