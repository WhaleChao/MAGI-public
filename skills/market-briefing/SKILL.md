...
- `--task briefing [--notify 1] [--force 1] [--mode deep|technical|quick]`：產生晨報（默認深度模式）
...
| **deep** | technical + 支撐/阻力位、成交量趨勢、ADX 趨勢強度 |
...
## 狀態檔
- `/Users/ai/Desktop/MAGI/.agent/market_watchlist.json`
- `/Users/ai/Desktop/MAGI/.agent/market_data_cache.json`
- `/Users/ai/Desktop/MAGI/.agent/market_perf_history.json`
