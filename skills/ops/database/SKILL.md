...
${MAGI_PYTHON_EXECUTABLE} ${MAGI_ROOT}/skills/ops/database/backup_restore.py --task backup --target both --keep-days 30

# list recent backups
${MAGI_PYTHON_EXECUTABLE} ${MAGI_ROOT}/skills/ops/database/backup_restore.py --task list --limit 20

# restore a backup to remote (requires explicit confirmation flag)
${MAGI_PYTHON_EXECUTABLE} ${MAGI_ROOT}/skills/ops/database/backup_restore.py --task restore --file /abs/path/to/backup.sql.gz --restore-target remote --yes-i-understand
```
