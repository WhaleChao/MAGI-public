...
_NAS_HOME_SHARE_PREFIXES = [
    str(_HOME / ".magi_mounts/homes/MAGI_NAS_SHARE"),
    str(_HOME / ".magi_mounts/homes"),
]
for _vol_base in ("homes", "homes-1", "homes-2", "homes-3"):
    _NAS_HOME_SHARE_PREFIXES.append(f"/Volumes/{_vol_base}/MAGI_NAS_SHARE")
...
def _resolve_pdf_with_synology_fallback(pdf_path: str) -> str:
    ...
    Maps SMB/NAS prefixes (e.g. /Volumes/homes-1/MAGI_NAS_SHARE/...) to local
