...
def test_go_live_docs_scan_uses_prepared_opening_folder(tmp_path):
    case_dir = tmp_path / "2026-0055-測試乙-二審-測試案由"
...
def test_laf_norm_token_unifies_common_name_variants():
    assert LAFOrchestrator._norm_token("遊某某") == LAFOrchestrator._norm_token("游某某")
    assert LAFOrchestrator._norm_token("王臺某") == LAFOrchestrator._norm_token("王台某")
