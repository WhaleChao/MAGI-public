...
def test_private_readme_keeps_private_repository_clone_target():
    readme = (ROOT / "README.md").read_text(encoding="utf-8")
    readme_zh = (ROOT / "README.zh-TW.md").read_text(encoding="utf-8")

    assert "git clone https://github.com/WhaleChao/MAGI-v2.git" in readme
    assert "git clone https://github.com/WhaleChao/MAGI-v2.git" in readme_zh
