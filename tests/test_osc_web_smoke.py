...
def test_cases_post_creates_folder_when_expected_path_missing(client, monkeypatch):
    import api.blueprints.osc_cases as mod
    ...
    assert body["folder"]["ok"] is True
    assert folders
    assert folders[0][1]["case_number"] == "2026-0102"
    assert folders[0][1]["client_name"] == "謝易霖測試二"
