...
def test_forms_frontend_uses_local_date_default():
    ...
    assert "osc-events.js?v=20260708-local-form-date-v1" in osc_html
...
def test_paperclip_todo_complete_buttons_are_visible_in_all_todo_surfaces():
    ...
    assert "osc-utils.js?v=20260709-source-helper-v1" in osc_html
    ...
    assert "documents.js?v=20260709-source-helper-v1" in osc_html
